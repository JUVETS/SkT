...
> **Die PowerShell ISE (Integrated Scripting Environment) wird nicht mehr weiterentwickelt und steht nur unter Windows PowerShell 5.1 zur Verfügung.** Für die Skriptentwicklung in diesem Kurs wird **Visual Studio Code** (siehe 1.2) verwendet.
...
**Visual Studio Code (VS Code)** ist der empfohlene Editor für die PowerShell-Entwicklung in diesem Kurs – kostenlos, plattformübergreifend (Windows, macOS, Linux) und mit vollständiger PowerShell-Unterstützung.
...
- **Mongo Shell**
  - [Download MongoDB Shell (aktuelle Version)](https://www.mongodb.com/try/download/shell) – MSI für Windows wählen
...
- Der nachfolgenden Link führt zu einem Tutorial [Get Started with Atlas (Atlas UI)](https://www.mongodb.com/docs/atlas/getting-started).
...
- **Connection string**: `mongosh "mongodb+srv://<cluster>.mongodb.net/" --apiVersion 1 --username <db_username> --password <password>`
  ...
  > Den genauen Connection-String findest du in Atlas unter: **Database → Connect → Shell**.
